...
from SACHINxSANATANIxMUSIC.utils.database import get_lang
from SACHINxSANATANIxMUSIC.utils.decorators.language import LanguageStart, languageCB
from SACHINxSANATANIxMUSIC.utils.inline.help import help_back_markup, private_help_panel
...
@app.on_message(filters.command(["help", "IShelp"]) & filters.private & ~BANNED_USERS)
...
@app.on_message(filters.command(["help", "ishelp"]) & filters.group & ~BANNED_USERS)
@LanguageStart
