...
from SACHINxSANATANIxMUSIC.utils.decorators.admins import ActualAdminCB
from SACHINxSANATANIxMUSIC.utils.decorators.language import language, languageCB
from SACHINxSANATANIxMUSIC.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from SACHINxSANATANIxMUSIC.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


@app.on_message(
    filters.command(["ISsettings", "ISsetting"]) & filters.group & ~BANNED_USERS
)
@language
