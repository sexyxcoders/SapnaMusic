...
from SACHINxSANATANIxMUSIC.mongo.readable_time import get_readable_time
from SACHINxSANATANIxMUSIC.mongo.afkdb import add_afk, is_afk, remove_afk



@app.on_message(filters.command(["ISafk", "ISbrb"], prefixes=["/", "!"]))
