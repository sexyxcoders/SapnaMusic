...
from SACHINxSANATANIxMUSIC.mongo.couples_db import _get_image, get_couple
...
@app.on_message(filters.command("IScouples"))
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "SACHINxSANATANIxMUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "SACHINxSANATANIxMUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("SACHINxSANATANIxMUSIC/assets/cppic.png")
