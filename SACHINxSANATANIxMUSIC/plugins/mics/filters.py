...
from SACHINxSANATANIxMUSIC.mongo.filtersdb import *
from SACHINxSANATANIxMUSIC.utils.filters_func import GetFIlterMessage, get_text_reason, SendFilterMessage
from SACHINxSANATANIxMUSIC.utils.yumidb import user_admin
from pyrogram import filters
from pyrogram.enums import ChatMemberStatus
from pyrogram.types import CallbackQuery, InlineKeyboardButton, InlineKeyboardMarkup

@app.on_message(filters.command("ISfilter") & admin_filter)
@user_admin
