...
@app.on_message(filters.command(["ISban"]))
...
@app.on_message(filters.command(["ISunban"]))
...
@app.on_message(filters.command(["ISmute"]))
...
@app.on_message(filters.command(["ISunmute"]))
...
@app.on_message(filters.command(["IStmute"]))
