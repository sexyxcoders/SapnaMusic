...
from SACHINxSANATANIxMUSIC.utils.database import add_sudo, remove_sudo
from SACHINxSANATANIxMUSIC.utils.decorators.language import language
from SACHINxSANATANIxMUSIC.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    #await message.reply_photo(photo="https://files.catbox.moe/wm0198.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
    await message.reply_photo(photo="https://files.catbox.moe/wm0198.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("ᴄʜᴀʟᴀ ᴊᴀ ʙʜᴏsᴅɪᴋᴇ  [ ᴏᴡɴᴇʀ :- @Swagger_Soul ]", show_alert=True)
    else:
